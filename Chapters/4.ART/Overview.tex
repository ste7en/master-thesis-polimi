...
The system architecture of their XRaaS is composed by different technologies implemented in modules, each reflecting a phase of the creation process of \gls{XR} experiences, and presented in Figure \todo{: figure of the system}. The system is composed as follows:
\begin{itemize}
